...
--projects com.kinlhp:moname-commons-api [--threads <THREADS>] \
...
### [Spring Boot 3.0 Migration Guide](#spring-boot-3.0-migration-guide)
...
* [Externalized Configuration | Activation Properties](https://docs.spring.io/spring-boot/reference/features/external-config.html#features.external-config.files.activation-properties)
...
* [Structure @Configuration Classes for Inclusion in Slice Tests](https://docs.spring.io/spring-boot/how-to/testing.html#howto.testing.slice-tests)
