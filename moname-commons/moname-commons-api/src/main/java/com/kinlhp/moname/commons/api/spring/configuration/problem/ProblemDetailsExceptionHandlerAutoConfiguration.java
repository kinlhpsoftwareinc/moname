package com.kinlhp.moname.commons.api.spring.configuration.problem;
...
public class ProblemDetailsExceptionHandlerAutoConfiguration extends ResponseEntityExceptionHandler {
	...
	public void postConstruct() {
		LOG.debug("Autoconfiguring exception handler to return a response with RFC 7807 formatted error details in the body");
	}
