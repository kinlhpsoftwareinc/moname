...
public class ExtendedKeycloakContainer<SELF extends ExtendedKeycloakContainer<SELF>>
	...
	public static final int KC_HTTPS_PORT = 8443;

	@Nonnull
	public static final String KC_HTTP_RELATIVE_PATH_PATTERN = "https://%s:%s%s";

	@Nonnull
	public static final URI DEFAULT_ISSUER_URI = URI.create("%s%s".formatted(KC_HTTP_RELATIVE_PATH_PATTERN.formatted(KEYCLOAK, KC_HTTPS_PORT, KC_HTTP_RELATIVE_PATH), REALM_PATH));
	...
	/**
	 * Requires a MySQL instance having {@literal mysql} as hostname on the same bridge network
	 *
