...
final class ClientCredentialsFlowExtensionPlatformTestKitIT
	...
	protected void assertTestEvents(@Nonnull final Events events) {
		events.assertStatistics(statistics -> statistics.succeeded(1L));
	}
	...
	static final class ClientCredentialsIT implements ClassToBeTested {
		 ...
		 * com.kinlhp.moname.commons.test.spring.security.ClientCredentialsFlowExtensionPlatformLauncherIT.ClientCredentialsIT#methodToBeTested
		 * methodToBeTested}
		 */
