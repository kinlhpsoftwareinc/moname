...
```sh
../../mvnw [--activate-profiles <PROFILES>] [--also-make-dependents] \
--batch-mode --no-transfer-progress --projects com.kinlhp:moname-commons-test \
...
### [JUnit Platform](#junit-platform-test-kit)

* [JUnit Platform Test Kit](https://docs.junit.org/snapshot/user-guide/#testkit)

### [AssertJ DB query logging](#datasource-proxy)
