...
import static com.kinlhp.moname.commons.jpa.entity.ulid.bytes.AbstractBytesAutoUlidIdentifiable.ENTITY;
...
@Table(name = TABLE)
public abstract class AbstractBytesAutoUlidIdentifiable extends AbstractBytesUlidIdentifiable {

	@Serial
	private static final long serialVersionUID = 7731150052831675879L;

	@Nonnull
	public static final String DISCRIMINATOR_VALUE = "BYTES_AUTO";

	@Nonnull
	public static final String ENTITY = "AbstractBytesAutoUlidIdentifiable";

	public AbstractBytesAutoUlidIdentifiable(@Nonnull final byte[] pk) {
		super(pk);
	}
