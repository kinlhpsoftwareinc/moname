...
import static com.kinlhp.moname.commons.jpa.entity.ulid.ulid.AbstractUlidUlidUlidIdentifiable.ENTITY;
...
@Table(name = TABLE)
public abstract class AbstractUlidUlidUlidIdentifiable extends AbstractUlidUlidIdentifiable {

	@Serial
	private static final long serialVersionUID = -2386867026587117053L;

	@Nonnull
	public static final String DISCRIMINATOR_VALUE = "ULID_ULID";

	@Nonnull
	public static final String ENTITY = "AbstractUlidUlidUlidIdentifiable";

	public AbstractUlidUlidUlidIdentifiable(@Nonnull final Ulid pk) {
		super(pk);
	}
